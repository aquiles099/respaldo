    ...
    public function details(Request $request, $id, $readonly = false) {
      ...
      */
      $data = [
        ...
        'from_country'          => $request->all()['from_country'],
        'to_country'            => $request->all()['to_country'],
        ...
        'shipper'               => $request->all()['shipper'] == 0 ? null : $request->all()['shipper'] ,
        'consigneer'            => $request->all()['consigneer'] == 0 ? null : $request->all()['consigneer'] ,
