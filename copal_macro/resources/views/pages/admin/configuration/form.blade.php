              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                 ...
                 <div class="form-group row @include('errors.field-class', ['field' => 'country_company'])">
                   ...
                   <div class="col-lg-9">
                     <select class="form-control" name="country_company" placeholder="{{trans('messages.country_company')}}" required="false" value="{{Input::get('country_company')}}" id="country_company">
                       @if(isset($countrys))
                             ...
                             <div class="row" id="divTracking" style="">
                              ...
                              <div class="col-md-8">
                                <div class=" dimensmedidas  @include('errors.field-class', ['field' => 'description'])"  id="divlarge" >
                                  <label class="col-lg-2 control-label" id="typeLabel" >{{trans('Nombre')}}</label>
                                  <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="{{trans('Nombre del estado')}}" id="name1" name="name1" type="float" min="1"  value="" @include('form.readonly')>
                                ...
                                <div class=" dimensmedidas  @include('errors.field-class', ['field' => 'description'])"  id="divlarge" >
                                  ...
                                  <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="{{trans('package.description')}}" id="description1" name="description1" type="float" min="1"  value="" @include('form.readonly')>
                                        @include('errors.field', ['field' => 'description'])
                                  </div>
                                </div>
                              </div>
