            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group row @include('errors.field-class', ['field' => 'address_country'])">
                  ...
                  <div class="col-lg-10">
                        <select class="form-control" id ="address_country" name="address_country" placeholder="{{trans('messages.country')}}"  value="{{isset($suppliers) ? $suppliers->address_country : Input::get('address_country')}}" @include('form.readonly')>
                        @if(isset($countrys))
              ...
              <div class="col-md-12">
                ...
                <div class="form-group row @include('errors.field-class', ['field' => 'billing_address_country'])">
                  <label class="col-lg-2 control-label">{{trans('messages.country')}}</label>
                  <div class="col-lg-10">
                        <select class="form-control" id ="billing_address_country" name="billing_address_country" placeholder="{{trans('messages.country')}}"  value="{{isset($suppliers) ? $suppliers->billing_address_country : Input::get('billing_address_country')}}" @include('form.readonly')>
                        @if(isset($countrys))
                          @foreach($countrys as $country)
                            <option value="{{$country}}">{{$country}}</option>
                          @endforeach
          ...
          <div class="panel-body">
           ...
           <!-- Normalmente paga por -->
            ...
            <div class="form-group row @include('errors.field-class', ['field' => 'payments_term_bill'])">
                ...
                <div class="col-lg-10">
                    <select class="form-control" id ="payments_term_bill" name="payments_term_bill" placeholder="{{trans('suppliers.coin')}}"  value="{{isset($suppliers) ? $suppliers->payments_term_bill : Input::get('payments_term_bill')}}" @include('form.readonly')>
