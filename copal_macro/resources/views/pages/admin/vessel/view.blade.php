      ...
      <fieldset class="form">
        ...
        <div class="form-group row @include('errors.field-class', ['field' => 'country'])">
          ...
          <div class="col-lg-9">
            ...
            <select class="form-control" id="ics_vessel_country" name="country" required="true" value="{{isset($vessel) ? $vessel->getCountry->name : Input::get('country')}}" @include('form.readonly') >
        ...
        <div class="form-group row @include('errors.field-class', ['field' => 'city'])">
          ...
          <div class="col-lg-9">
            @if(!isset($readonly) || $readonly == false)
            <select class="form-control" id="ics_vessel_city" name="city" required="true" value="{{isset($vessel) ? $vessel->getCity->name : Input::get('city')}}" @include('form.readonly') >
              <option value="0">{{trans('route.selectOption')}}</option>
              @if(isset($view))
