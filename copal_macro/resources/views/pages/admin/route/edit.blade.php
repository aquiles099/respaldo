...
@section('title-actions')
  <div class="btn-group" role="group" item="{{$routes->toInnerJson()}}">
    <a href="{{asset('admin/routes')}}" class="btn btn-default" title="{{trans('route.list')}}">
      <i class="fa fa-list" aria-hidden="true"></i>
      {{trans('messages.list')}}
    </a>
    @if(!isset($readonly) || !$readonly)
      <a onclick="routesDelete($(this), false)" class="btn btn-default" title="{{trans('messages.delete')}}">
