<form onsubmit="submitForm()" role="form" action="{{asset($path)}}" method="post">
  @if(isset($user))
    ...
    <div class="form-group row @include('errors.field-class', ['field' => 'country'])">
      ...
      <div class="col-lg-9">
        @if(!isset($readonly) || $readonly == false)
          <select class="form-control" id ="country" name="country" placeholder="{{trans('messages.country')}}" required="true" value="{{isset($user) ? $user->country : Input::get('country')}}" @include('form.readonly')>
            @if(isset($countrys))
