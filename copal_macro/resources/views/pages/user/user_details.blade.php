              ...
              <div class="panel-body">
                <fieldset>
                  ...
                  <div class="form-group @include('errors.field-class', ['field' => 'sex'])">
                    ...
                    <div class="col-lg-9">
                      <input class="form-control" placeholder="{{trans('messages.sex')}}" name="sex" type="text" value="{{$user->sex == 'm' ? trans('messages.male') : trans('messages.female')}}"  required="true">
                  ...
                  <div class="form-group @include('errors.field-class', ['field' => 'password'])">
                    <label class="col-lg-3 control-label" for="content" id="label">
                        ...
                        <span class="pull-right">
                          <a class="infoRd" href="{{asset('/account/tracking/user/pass')}}" data-toggle="tooltip" title="{{trans('messages.changepassword')}}"><i aria-hidden="true" class="fa fa-refresh"></i></a>
                        </span>
                    </label>
                    <div class="col-lg-9">
