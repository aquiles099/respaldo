    ...
    <div class="row">
    	<div class="col-md-6">
    		...
    		<div class="@include('errors.field-class', ['field' => 'exporter'])"  id="divlarge" >
              ...
              <textarea type="text" class="form-control" placeholder="{{trans('billoflading.exporter')}}" id="exporter" name="exporter" type="text" rows="5" min="1" required="true" value="{{isset($billoflading) ? strtoupper($billoflading->exporter) : clear(Input::get('obervation'))}}" @include('form.readonly')> {{isset($billoflading) ? preg_replace('<<BR />>','',strtoupper($billoflading->exporter)) : clear(Input::get('obervation'))}}</textarea>
            ...
            <div class="@include('errors.field-class', ['field' => 'consigne'])"  id="divlarge" >
              ...
              <textarea type="text" class="form-control" placeholder="{{trans('billoflading.consigne')}}" id="consigne" name="consigne" type="text" rows="5" min="1" required="true" value="{{isset($billoflading) ? $billoflading->consignedto : clear(Input::get('consignedto'))}}" @include('form.readonly')>{{isset($billoflading) ? preg_replace('<<BR />>','',strtoupper($billoflading->consignedto)) : clear(Input::get('consignedto'))}}</textarea>
            ...
            <div class="@include('errors.field-class', ['field' => 'notify'])"  id="divlarge" >
              ...
              <textarea type="text" class="form-control" placeholder="{{trans('billoflading.notify')}}" id="notify" name="notify" type="text" rows="4" min="1" required="true" value="{{isset($billoflading) ? $billoflading->notify : clear(Input::get('notify'))}}" @include('form.readonly')> {{isset($billoflading) ? preg_replace('<<BR />>','',strtoupper($billoflading->notify)) : clear(Input::get('notify'))}}</textarea>
