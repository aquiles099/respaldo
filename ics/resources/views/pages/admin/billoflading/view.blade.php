...
<form role="form" action="" id="billoflading" method="post">
  <fieldset class="form">
    		...
    		<div class="row">
    			...
    			<div class="col-md-6">
    				<div class="@include('errors.field-class', ['field' => 'bl'])"  id="divlarge" >
	              		...
	              		<input type="text" class="form-control" placeholder="{{trans('billoflading.bl')}}" id="bl" name="bl" type="text"  min="1" required="true" readonly="" value="{{isset($pickup) ? $pickup->code : clear(Input::get('bl'))}}" @include('form.readonly')>
    ...
    <div class="row">
    	<button type="button" class="btn btn-primary" style="float: right;margin-right: 20px;margin-top: 20px;" onclick="resultbill({{$pickup->id}})"> Generar Reporte</button>    	
    </div>
