  ...
  var path  =`${window.location.origin}${window.location.pathname}`;
   if (open == 'true'){
      ...
      var alert = false;
       ...
       bootbox.dialog({
          title: "<a href='' id='bckic' title='atrás' name =''><span class= 'pull-left glyphicon glyphicon-menu-left'></span></a><span id='tltgnif'>Informacion</span>",
          ...
          console.log(path+"/showconsolidated/"+id);
