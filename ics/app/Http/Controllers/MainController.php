    ...
    switch ($session['type'])
    {
      ...
      [
        ...
        */
        ...
        'sendBookings'     => $sendBookings,
        'transitBookings'  => $transitBookings,
        'arribedBooking'   => $arribedBookings,
        ...
        */
        ...
        'sendShipments'      => $sendShipments,
        'transitShipments'   => $transitShipments,
        'arribedShipments'   => $arribedShipments,
        ...
        */
        'releases'           => $releases,
        'receivedReleases'   => $receivedReleases,
        'sendReleases'       => $sendReleases,
        'transitReleases'    => $transitReleases,
        'arribedReleases'    => $arribedReleases,
        //'noInvoiceShipments' => $noInvoiceShipments,
