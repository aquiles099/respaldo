...
class ConfigurationController extends Controller {
    ...
    public function index(Request $request) {
     ...
     //GUARDANDO ESTATUS DE RESERVAS
     $x = $request->all()['countpackBookings'];
     for ($i = 1; $i <= $x; $i++) {
       if ((isset($request->all()['nameBookings'.$i]))&&(isset($request->all()['descriptionBookings'.$i]))){
         $status = BookingStatus::find($i);
         $vars=[
           'name'           => $request->all()['nameBookings'.$i],
           'description'    => $request->all()['descriptionBookings'.$i],
           'notification'    => '',
           'step' => '0',
           'active'         => '1'
         ];
     ...
     //GUARDANDO ESTATUS DE EMBARQUES
     $x = $request->all()['countpackShipment'];
     for ($i = 1; $i <= $x; $i++) {
       if ((isset($request->all()['nameShipment'.$i]))&&(isset($request->all()['descriptionShipment'.$i]))){
         $status = ShipmentStatus::find($i);
         $vars=[
           'name'           => $request->all()['nameShipment'.$i],
           'description'    => $request->all()['descriptionShipment'.$i],
           'notification'    => '',
           'step' => '0',
           'active'         => '1'
         ];
     ...
     //GUARDANDO ESTATUS DE LIBERACION DE CARGA
     $x = $request->all()['countpackRelease'];
     for ($i = 1; $i <= $x; $i++) {
       if ((isset($request->all()['nameRelease'.$i]))&&(isset($request->all()['descriptionRelease'.$i]))){
         $status = ReleaseStatus::find($i);
         $vars=[
           'name'           => $request->all()['nameRelease'.$i],
           'description'    => $request->all()['descriptionRelease'.$i],
           'notification'    => '',
           'step' => '0',
           'active'         => '1'
         ];
