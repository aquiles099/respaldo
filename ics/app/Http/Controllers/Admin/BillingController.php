    ...
    */
    public function searchData(Request $request) {
        ...
        */
        ...
        if ($typeSelect == 6) {
          $id_route = $request->all()['route'];
          $ruta = Route::find($id_route);
          $data       = Detailspackage::query()->where('route', '=',$id_route)->get();
          $typeReport = 6;
          $nameReport = "Envios para la Ruta ".(isset($ruta->name) ? ($ruta->name) : '');
        }
        /**
        *
        */
