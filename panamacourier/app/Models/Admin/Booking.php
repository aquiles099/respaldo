...
class Booking extends Model
{
    ...
    */
    ...
    public function getAgent() {
      return $this->hasOne('App\Models\Admin\User','id','agent');
    }
    /**
    * Obtiene el evento actual
    */
    public function getLastEvent() {
      return $this->hasOne('App\Models\Admin\BookingStatus', 'id', 'last_event');
    }
    /**
    *
    */
      ...
      Booking::creating(function(Booking $booking) {
        ...
        */
        if($booking->code == null || $booking->code == '') {
          $booking->code = "BKG-".str_pad($booking->id,5,'0',STR_PAD_LEFT);
        }
        /**
