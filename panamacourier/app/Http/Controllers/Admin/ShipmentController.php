...
class ShipmentController extends Controller {
  ...
  public function details(Request $request, $id, $readonly = false) {
    ...
    */
    if($type == 1) {
      ...
      * informacion general
      */
      $since_departure         = !isset($request->all()['since_departure_maritime'])||($request->all()['since_departure_maritime'] == "") ? null : $request->all()['since_departure_maritime'] ;
      $hour_departure          = !isset($request->all()['hour_departure_maritime'])||($request->all()['hour_departure_maritime'] == "") ? null : $request->all()['hour_departure_maritime'] ;
      $since_arrived           = !isset($request->all()['since_arrived_maritime'])||($request->all()['since_arrived_maritime'] == "") ? null : $request->all()['since_arrived_maritime'] ;
      $hour_arrived            = !isset($request->all()['hour_arrived_maritime'])||($request->all()['hour_arrived_maritime'] == "") ? null : $request->all()['hour_arrived_maritime'] ;
      $transporter_shipment    = !isset($request->all()['preTransportMaritime_shipment'])||($request->all()['preTransportMaritime_shipment'] == 0) ? null : $request->all()['preTransportMaritime_shipment'] ;
      /**
      * informacion de rutas
      */
      $origin_point           = !isset($request->all()['originPointMaritime_shipment'])||($request->all()['originPointMaritime_shipment'] == "") ? null : $request->all()['originPointMaritime_shipment'];
      $origin_pre_transporter = !isset($request->all()['preTransportPlaceMaritime_shipment'])||($request->all()['preTransportPlaceMaritime_shipment'] == 0) ? null : $request->all()['preTransportPlaceMaritime_shipment'];
    ...
    */
    if($type == 2) {
      ...
      */
      ...
      $from_country        = ($request->all()['from_country_shipment'] == 0) ? null : $request->all()['from_country_shipment'];
      $from_airport        = ($request->all()['fromAerial_shipment'] == 0) ? null : $request->all()['fromAerial_shipment'];
      $to_country          = ($request->all()['to_country_shipment'] == 0)||(!isset($request->all()['to_country_shipment'])) ? null : $request->all()['to_country_shipment'];
      $to_airport          = ($request->all()['toAerial_shipment'] == 0)||(!isset($request->all()['toAerial_shipment'])) ? null : $request->all()['toAerial_shipment'];      $date_city_departure = ($request->all()['departureDateAerial_shipment'] == "") ? null : $request->all()['departureDateAerial_shipment'];
    ...
    */
    $data = [
      ...
      'transport'             => $type,
      'to_country'             => isset($to_country)?$to_country : null,
      'to_airport'             => isset($to_airport)?$to_airport : null,
      'from_country'           => isset($from_country)?$from_country : null,
      'from_airport'           => isset($from_airport)?$from_airport : null,
      'container_name' => $request->all()['containerized'],
      'currency'              => $request->all()['currency'],
      'type_file'             => isset($request->all()['type_file']) ? ($request->all()['type_file']) : null,
      'invoice_number'        => isset($request->all()['invoice_number']) ? ($request->all()['invoice_number']) : null,
      'po_number'             => isset($request->all()['po_number']) ? ($request->all()['po_number']) : null,
      'payment'               => $request->all()['payment'],
      'type_payment'          => $request->all()['type_payment'],
      'dangerous'             => $request->all()['dangerous'],
      'agent_charges'         => $request->all()['agent_charges'],
      'transport_charges'      => $request->all()['transport_charges'],
      'tax'                   => $request->all()['tax'],
      ...
      'containerized'         => ($request->all()['containerized'] == 0 ) ? 0 : $request->all()['containerized'],
      ...
      if(is_string($value)) {
        if(strstr($value, 'wr') || strstr($value, 'pk')) {
            ...
            */
            ...
            $data_detail = [
              'shipment'  => $shipment->id,
              'pickup'    => (strstr($value, 'pk')) ? $val : null,
              'warehouse' => (strstr($value, 'wr')) ? $val : null
            ];
    ...
    *
    */
    return $this->doRedirect($request, "/admin/l/shipments")->with('successMessage', trans('shipment.updated', [
      'code' => $shipment->code,
      'name' => $shipment->name
    ]));
  }
  ...
  */
  public function create(Request $request) {
    ...
    */
    if($type == 2) {
      ...
      */
      ...
      $from_airport        = ($request->all()['fromAerial_shipment'] == 0) ? null : $request->all()['fromAerial_shipment'];
      $to_country          = ($request->all()['to_country_shipment'] == 0)||(!isset($request->all()['to_country_shipment'])) ? null : $request->all()['to_country_shipment'];
      $to_airport          = ($request->all()['toAerial_shipment'] == 0)||(!isset($request->all()['toAerial_shipment'])) ? null : $request->all()['toAerial_shipment'];
    ...
    *
    */
    return $this->doRedirect($request, "/admin/l/shipments")->with('successMessage', trans('shipment.created', [
      'code' => $shipment->code,
      'name' => $shipment->name
    ]));
  }
  ...
  */
  public function delete(Request $request, $id) {
    $redirect = $this->doRedirect($request, '/admin/l/shipments');
    $shipment = Shipment::find($id);
    if(is_null($shipment)) {
  ...
  */
  public function view(Request $request, $id) {
    ...
    $shipment       = Shipment::find($id);
    $event          = ShipmentStatus::query()->where('active','=','1')->get();
  ...
  */
  public function loadRoutes(Request $request, $id, $shipment) {
    ...
    $from_pais         = isset($shipment->from_country) ? Pais::find($shipment->from_country) : null;
    $from_airports     = isset($from_pais) ? (IataCode::query()->where('iso','=',$from_pais->code)->get()) : null;

    $to_pais         = isset($shipment->to_country) ? Pais::find($shipment->to_country) : null;
    $to_airports     = isset($to_pais) ? IataCode::query()->where('iso','=',$to_pais->code)->get() : null;
    ...
    */
    $vars = [
      ...
      'shipment'      => $shipment,
      'shipment_route'=> ($shipment != null ) ? ShipmentRoute::byShipment($shipment->id)->first() : null,
      'shipment_detail'=> ($shipment != null ) ? ShipmentDetail::byShipment($shipment->id)->first() : null
    ];
    /**
    *
    */
  ...
  */
  ...
  public function iata(Request $request, $id) {
    $country = Pais::find($id);
    $airport = IataCode::query()->where('iso','=',$country->code)->get();
    if ($airport) {
      return response()->json([
          'message' => true,
          'airports' => $airport
