    ...
    //  dd($vars);
      ...
      *//*
      ...
      if ($lang=='es') {
        ...
        $pageCount = $fpdi->setSourceFile('tmpreport/WHR_en.pdf');
      }
...
*/
      ...
      if ($package->type == 3) {
        $fpdi->SetXY(165, $h);
        $fpdi->MultiCell(25, 3,number_format($package->volumetricweightm,2,',','.').' Vlb', 0, 'R');
      }
    ...
    public function receiptpickupid(Request $request, $id) {
      ...
      */
      ...
      if ($lang=='es') {
        ...
        $pageCount = $fpdi->setSourceFile('tmpreport/pickupOrder_en.pdf');
      }
      $tplIdx    = $fpdi->importPage(1, '/BleedBox');
      ...
      if ($lang=='es') {
        ...
        $fpdi->MultiCell(80, 4, 'Pick Up Order',0,'L');
      }
    ...
    public function loadingguide (Request $request, $id){
      ...
      */
      ...
      if ($lang=='es') {
        ...
        $pageCount = $fpdi->setSourceFile('tmpreport/invoice_en.pdf');
      }
      $tplIdx    = $fpdi->importPage(1, '/BleedBox');
