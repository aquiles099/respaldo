      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ul class="nav nav-tabs nav-justified" id="typet">
            <li id="ics_inactive_tab0" class="active"><a data-toggle="tab" href="#ics_tab_home">{{ucfirst(trans('transporters.generalInfo'))}} <span><i class="fa fa-exchange" aria-hidden="true"></i></span></a></li>
          ...
          <div class="tab-content">
              <div id="ics_tab_home"  class="tab-pane fade in active">
                ...
                <div class="form-group row @include('errors.field-class', ['field' => 'exportation'])">
                   ...
                   <div class="col-lg-10">
                       <input type="text" class="form-control" id="exportation" name="exportation" value="{{isset($transporters) ? $transporters->exportation : Input::get('exportation')}}" placeholder="{{trans('transporters.numberexportation')}}" @include('form.readonly')>
                ...
                <div class="form-group row @include('errors.field-class', ['field' => 'divition'])">
                   ...
                   <div class="col-lg-10">
                       <input type="text" class="form-control" id="divition" name="divition" value="{{isset($transporters) ? $transporters->divition : Input::get('divition')}}" placeholder="{{trans('transporters.divition')}}" @include('form.readonly')>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <div class="form-group row @include('errors.field-class', ['field' => 'country'])">
                            ...
                            <div class="col-lg-10">
                                  <select style="width:100%;" class="form-control" id ="address_country" name="address_country" placeholder="{{trans('messages.country')}}"  value="{{isset($transporters) ? $transporters->address_country : Input::get('address_country')}}" @include('form.readonly')>
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="form-group row @include('errors.field-class', ['field' => 'billing_address_street'])">
                             <label class="col-lg-2 control-label" id="typeLabel" >{{trans('transporters.street')}}</label>
                             <div class="col-lg-10">
                                 <input type="text" class="form-control" id="billing_address_street" name="billing_address_street" value="{{isset($transporters) ? $transporters->billing_address_street : Input::get('address_street')}}" placeholder="{{trans('transporters.street')}}" @include('form.readonly')>
                             @include('errors.field', ['field' => 'address_street'])
                            </div>
                          </div>
                          ...
                          <div class="form-group row @include('errors.field-class', ['field' => 'billing_address_country'])">
                            <label class="col-lg-2 control-label">{{trans('messages.country')}}</label>
                            <div class="col-lg-10">
                                  <select style="width:100%;" class="form-control" id ="billing_address_country" name="billing_address_country" placeholder="{{trans('messages.country')}}"  value="{{isset($transporters) ? $transporters->billing_address_country : Input::get('address_country')}}" @include('form.readonly')>
                                    <option value="0">{{trans('messages.optionSelect')}}</option>
                                  @if(isset($countrys))
                                    @foreach($countrys as $country)
                                      <option value="{{$country}}">{{$country}}</option>
                          ...
                          <div class="form-group row @include('errors.field-class', ['field' => 'billing_address_city'])">
                             <label class="col-lg-2 control-label" id="typeLabel" >{{trans('transporters.city')}}</label>
                             <div class="col-lg-10">
                                 <input type="text" class="form-control" id="billing_address_city" name="billing_address_city" value="{{isset($transporters) ? $transporters->billing_address_city : Input::get('address_city')}}" placeholder="{{trans('transporters.city')}}" @include('form.readonly')>
                             @include('errors.field', ['field' => 'address_city'])
                            </div>
                          </div>
                          ...
                          <div class="form-group row @include('errors.field-class', ['field' => 'address_state'])">
                             <label class="col-lg-2 control-label" id="typeLabel" >{{trans('transporters.state')}}</label>
                             <div class="col-lg-10">
                                 <input type="text" class="form-control" id="billing_address_state" name="billing_address_state" value="{{isset($transporters) ? $transporters->billing_address_state : Input::get('address_state')}}" placeholder="{{trans('transporters.state')}}" @include('form.readonly')>
                             @include('errors.field', ['field' => 'address_state'])
                            </div>
                          </div>
                          ...
                          <div class="form-group row @include('errors.field-class', ['field' => 'address_code'])">
                             <label class="col-lg-2 control-label" id="typeLabel" >{{trans('transporters.code')}}</label>
                             <div class="col-lg-10">
                                 <input type="text" class="form-control" id="billing_address_code" name="billing_address_code" value="{{isset($transporters) ? $transporters->billing_address_code : Input::get('address_code')}}" placeholder="{{trans('transporters.code')}}" @include('form.readonly')>
                             @include('errors.field', ['field' => 'address_code'])
                            </div>
                          </div>
                          ...
                          <div class="form-group row @include('errors.field-class', ['field' => 'address_port'])">
                             <label class="col-lg-2 control-label" id="typeLabel" >{{trans('transporters.port')}}</label>
                             <div class="col-lg-10">
                                 <input type="text" class="form-control" id="billing_address_port" name="billing_address_port" value="{{isset($transporters) ? $transporters->billing_address_port : Input::get('address_port')}}" placeholder="{{trans('transporters.port')}}" @include('form.readonly')>
                             @include('errors.field', ['field' => 'address_port'])
                            </div>
                          </div>
                  ...
                  <div class="panel-body">
                   ...
                   <!-- Normalmente paga por -->
                    ...
                    <div class="form-group row @include('errors.field-class', ['field' => 'payments_term_coin'])">
                      ...
                      <div  class="col-lg-10">
                            <select style="width:100%;" class="form-control" id ="payments_term_coin" name="payments_term_coin" placeholder="{{trans('transporters.coin')}}"  value="{{isset($transporters) ? $transporters->payments_term_coin : Input::get('payments_term_coin')}}" @include('form.readonly')>
                              @if($transporters->payments_term_coin == '1')
                                <option value="1" selected>$ {{($lang=='es') ? 'Dolar': 'Dollar'}}</option>
                              @else
                                <option value="1">$ {{($lang=='es') ? 'Dolar': 'Dollar'}}</option>
                              @endif
                              @if($transporters->payments_term_coin == '2')
                    ...
                    <div class="form-group row @include('errors.field-class', ['field' => 'payments_term_pays'])">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="payments_term_pays" name="payments_term_creditlimit" value="{{isset($transporters) ? $transporters->payments_term_creditlimit : Input::get('payments_term_creditlimit')}}" placeholder="0.00" @include('form.readonly')>
                           @include('errors.field', ['field' => 'payments_term_pays'])
                       </div>
                    </div>
                    ...
                    <div class="form-group row @include('errors.field-class', ['field' => 'payments_term_bill'])">
                        ...
                        <div class="col-lg-10">
                            <select style="width:100%;" class="form-control" id ="payments_term_bill" name="payments_term_bill" placeholder="{{trans('transporters.coin')}}"  value="{{isset($transporters) ? $transporters->payments_term_bill : Input::get('payments_term_bill')}}" @include('form.readonly')>
                              @if($transporters->payments_term_bill == '0')
                               <option value="0" selected>{{trans('messages.optionSelect')}}</option>
                              @else
                                <option value="0">{{trans('messages.optionSelect')}}</option>
                              @endif
                              @if($transporters->payments_term_bill == '1')
                                <option value="1" selected>{{($lang=='es') ? 'Nunca Aplicar': 'Never apply'}}</option>
                              @else
                                <option value="1">{{($lang=='es') ? 'Nunca Aplicar': 'Never apply'}}</option>
                              @endif
                              @if($transporters->payments_term_bill == '2')
                                <option value="2" selected>{{($lang=='es') ? 'Mensual': 'Monthly'}}</option>
                              @else
                                <option value="2">{{($lang=='es') ? 'Mensual': 'Monthly'}}</option>
                              @endif
                              @if($transporters->payments_term_bill == '3')
                                <option value="3" selected>{{($lang=='es') ? 'Trimestral': 'Trimestral'}}</option>
                              @else
                                <option value="3">{{($lang=='es') ? 'Trimestral': 'Trimestral'}}</option>
                              @endif
                              @if($transporters->payments_term_bill == '4')
                                <option value="4" selected>{{($lang=='es') ? 'Semestral': 'Biannual'}}</option>
                              @else
                                <option value="4">{{($lang=='es') ? 'Semestral': 'Quarterly'}}</option>
                              @endif
                            </select>
                       </div>
                    </div>
