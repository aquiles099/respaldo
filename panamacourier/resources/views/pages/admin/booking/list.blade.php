...
@section('body')
  ...
  <div class="panel panel-default" id = "pnlin">
    <div class="panel-body">
      <table class="table table-striped table-hover table-responsive" id="dtble_booking">
        <thead>
          ...
          @if(isset($booking))
            @foreach($booking as $key => $value)
              <tr class="text-center" item="{{$value->toInnerJson()}}">
                ...
                <td>{{isset($value->getFromCountry->name) ? $value->getFromCountry->name : ''}}</td>
                <td>{{isset($value->getToCountry->name) ? $value->getToCountry->name:''}}</td>
                ...
                <td>
                  <ul class="table-actions">
                    ...
                    <li><a href="{{asset("/admin/bookings/receipt/{$value->id }")}}" target="_blank"><i class="fa fa-file-pdf-o" title="{{trans('invoice.acrobat')}}"></i></a></li>
