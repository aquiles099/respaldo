      ...
      <form onsubmit="javascript:createLoad()" class="" action="{{asset('admin/configuration')}}" method="post" enctype="multipart/form-data">
        ...
        <fieldset>
          <ul class="nav nav-tabs nav-justified">
            <li id="ics_inactive_tab0" class="active"><a data-toggle="tab" href="#ics_tab_home">
              {{ trans('configuration.general') }} <span><i class="fa fa-cog" aria-hidden="true"></i></span></a>
            </li>
            <li id="ics_inactive_tab5"><a data-toggle = "tab" href="#ics_tab_menu5">
              {{trans('configuration.load_users')}} <span><i class="fa fa-newspaper-o" aria-hidden="true"></i></span></a>
            </li>
            <li id="ics_inactive_tab1"><a data-toggle = "tab" href="#ics_tab_menu1">
              {{trans('configuration.reports')}} <span><i class="fa fa-file-text" aria-hidden="true"></i></span></a>
            </li>
            <li id="ics_inactive_tab2"><a data-toggle = "tab" href="#ics_tab_menu2">
              {{trans('configuration.label')}} <span><i class="fa fa-ticket" aria-hidden="true"></i></span></a>
            </li>
            <li id="ics_inactive_tab3"><a data-toggle = "tab" href="#ics_tab_menu3">
              {{trans('configuration.mail')}} <span><i class="fa fa-envelope" aria-hidden="true"></i></span></a>
            </li>
            <li id="ics_inactive_tab4"><a data-toggle = "tab" href="#ics_tab_menu4">
              {{trans('configuration.status_selection')}} <span><i class="fa fa-check-circle" aria-hidden="true"></i></span></a>
            </li>
            <li id="ics_inactive_tab6"><a data-toggle = "tab" href="#ics_tab_menu6">
              {{trans('configuration.load_rates')}} <span><i class="fa fa-usd" aria-hidden="true"></i></span></a>
            </li>
          </ul>
            ...
            <div id="ics_tab_menu6" class="tab-pane fade">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-12">
                      <label class="col-lg-2" for="import_rate">{{trans('configuration.upload_file')}}</label>
                      <input class="col-lg-9 form-control" type="file" accept="application/msexcel" style="width:40%;margin-left: 15px;" id="import_rate" name="import_rate" >
                    </div>
                  </div>
                  @if($lang == 'es')
                    <div style="margin-left: 90px;margin-top:20px;  " class="col-md-12">
                      <label for="">Especificaciones del archivo</label>
                      <p style="font-size: 12px;">- Asegurese de que su archivo cumpla con el siguiente <a href="{{URL::route('config.rates.format')}}">formato.</a></p>
                      <p style="font-size: 12px;">- El correo electronico de cada usuario es obligatorio, si este campo esta vacio, el usuario sera ignorado, es decir, no se registrará en la base de datos.</p>
                    </div>
                  @else
                    <div style="margin-left: 90px;margin-top:20px;  " class="col-md-12">
                      <label for="">File Specifications</label>
                      <p style="font-size: 12px;">- Be sure your file meets the requirements of this <a href="{{URL::route('config.rates.format')}}">format.</a></p>
                      <p style="font-size: 12px;">- The e-mail field is fully required, if this isn't filled, the user won't be saved.</p>
                    </div>
                  @endif
                </div>
