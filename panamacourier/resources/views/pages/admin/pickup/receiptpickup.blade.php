...
<html>
  <head>
    <meta charset="utf-8">
    <title>{{strtoupper(trans('messages.pickuporder'))}} - {{$package->code}}</title>
  ...
  <body class="pdfBody">
    ...
    <!--nombe de recibo-->
     <div style="background-color: #21517a; color: white; margin-top: 0px; text-align: center; font-size: 20px; font-weight: bold; border: 2px solid rgb(102, 102, 102);">
       <div style="margin-top: 5px; margin-bottom: 5px">
           <span >{{strtoupper(trans('messages.pickuporder'))}} - {{$package->code}}</span>
       </div>
     </div>
    ...
    <table style="width:100%;padding:0; margin:0">
      <tr>
        <td style="text-align: right!important;">
         ...
         <p style="padding:0px;line-height:14px;font-weight: bold">Tipo de Transporte: <span style="text-transform: uppercase;font-weight: 300">{{$package->getType != '' ? ($lang == 'es') ? strtoupper($package->getType->spanish strtoupper($package->getType->english) : trans('messages.unknown')}}</span></p>
    ...
    <table style="width: 100%; border: 2px solid rgb(102, 102, 102); border-collapse: collapse;">
      ...
      <tr style="border: 1px solid grey;">
        ...
        <td style="border: 1px solid grey;text-align: center;"> {{$row->volumetricweight}} ft<sup>3</sup></td>
      </tr>
       @endforeach
    </table>
    <!---->
