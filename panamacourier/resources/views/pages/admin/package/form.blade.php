<form role="form" action="{{asset($path)}}" method="post" onsubmit="createLoad()" novalidate enctype="multipart/form-data">
  ...
  <fieldset class="form">
    ...
    <div class="form-group row @include('errors.field-class', ['field' => 'company'])" id="company" style="display:block;"}}>
      ...
      <div class="col-lg-9">
      <select style="width:100%;" class="form-control" id="companySelect" name="companySelect"  @include('form.readonly') >
    ...
    <div class="form-group row @include('errors.field-class', ['field' => 'client'])" id="client" style="display:none;"}}>
      ...
      <div class="col-lg-9">
      <select style="width:100%;" class="form-control" id="clientSelect" name="clientSelect"  @include('form.readonly') >
  ...
  <div class="col-md-6" id="divdimens" style="display:none;">
      <div class="form-group row @include('errors.field-class', ['field' => 'type'])" id="type" >
        ...
        <div class="col-lg-9">
          <select style="width:100%;" class="form-control" id="type" name="type" required="true" @include('form.readonly')>
      ...
      <div class="form-group row @include('errors.field-class', ['field' => 'category'])" id="categoryDiv" style="display:none;">
        ...
        <div class="col-lg-9">
          <select style="width:100%;" class="form-control" id="category" name="category" required="true" @include('form.readonly')>
      ...
      <div class="form-group row @include('errors.field-class', ['field' => 'invoice'])" id="invoice" style="display:none;">
        ...
        <div class="col-lg-9">
          <select style="width:100%;" class="form-control" id="invoice" name="invoice" required="true" @include('form.readonly')>
      ...
      <div class="form-group row @include('errors.field-class', ['field' => 'consolidate'])" id="consolidate" style="display:block;">
        ...
        <div class="col-lg-9">
         <select style="width:100%;" class="form-control" id="consolidated" name="consolidated" required="true" @include('form.readonly')>
      ...
      <div class="form-group row @include('errors.field-class', ['field' => 'consolidate'])" id="consolidate" style="display:block;">
        ...
        <div class="col-lg-9">
         <select style="width:100%;" class="form-control" id="promotion" name="promotion" required="true" @include('form.readonly')>
