  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group @include('errors.field-class', ['field' => 'typeServiceGround_shipment'])">
        ...
        <select style="width:100%;" class ="form-control" type="text" id="typeServiceGround_shipment" name="typeServiceGround_shipment">
    ...
    <div class="col-md-4">
      <div class="form-group @include('errors.field-class', ['field' => 'typeTransportGround_shipment'])">
        ...
        <select style="width:100%;" class ="form-control" type="text" id="typeTransportGround_shipment" name="typeTransportGround_shipment">
          <option value="0">{{trans('shipment.selectOption')}}</option>
    ...
    <div class="col-md-4">
      <div class="form-group @include('errors.field-class', ['field' => 'typeRouteGround_shipment'])">
        ...
        <select style="width:100%;" class ="form-control" type="text" id="typeRouteGround_shipment" name="typeRouteGround_shipment">
          <option value="0">{{trans('shipment.selectOption')}}</option>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group @include('errors.field-class', ['field' => 'carrierGround_shipment'])">
        ...
        <select style="width:100%;" class ="form-control" type="text" id="carrierGround_shipment" name="carrierGround_shipment">
          <option value="0">{{trans('shipment.selectOption')}}</option>
...
<fieldset>
  ...
  <!---->
    <div class="col-md-4 form-group @include('errors.field-class', ['field' => 'fromGround_shipment'])">
      ...
      <select style="width:100%;" class ="form-control" type="text" id="fromGround_shipment" name="fromGround_shipment">
        <option value="0">{{trans('shipment.selectOption')}}</option>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group @include('errors.field-class', ['field' => 'toGround_shipment'])">
        ...
        <select style="width:100%;" class ="form-control" type="text" id="toGround_shipment" name="toGround_shipment">
          <option value="0">{{trans('shipment.selectOption')}}</option>
          @foreach($cities as $key => $value)
