        ...
        <form id="formulario"role="form" action="{{asset('/login')}}" method="post">
          <fieldset>
            <div class="form-group @include('errors.field-class', ['field' => 'username'])">
              <input id="username" class="form-control" placeholder="{{trans('messages.email')}}" name="username" type="text" autofocus maxlength="40" min="5" required="true" value="{{Input::get('username')}}">
