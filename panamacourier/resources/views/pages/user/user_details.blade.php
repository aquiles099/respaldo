...
<div class="panel panel-default" id="pnlin">
  ...
  <div class="panel-body" >
    <form role="form" action="{{asset($path)}}" method="post" data-toggle="validator">
        @if(isset($user))
              ...
              <div class="panel-body">
                <fieldset>
                  <div class="form-group @include('errors.field-class', ['field' => 'name'])">
                    ...
                    <div class="col-lg-9">
                      <input class="form-control" placeholder="{{trans('messages.name')}}" name="name" type="text" autofocus value="{{ucfirst($user->name)}}" required="true">
                  ...
                  <div class="form-group @include('errors.field-class', ['field' => 'sex'])">
                    <label class="col-lg-3 control-label" for="sex" id="label">{{trans('messages.sex')}}</label>
                    <div class="col-lg-9">
                      ...
                      <select class="form-control" name="sex" id="sex">
                          ...
                          @foreach($sex_user as $key => $value)
                            <option {{($user->sex == $value['id']) ? 'selected' : '' }} value="{{$value['id']}}">{{$value['text']}}</option>
                          @endforeach
                      </select>
                  ...
                  <div class="form-group @include('errors.field-class', ['field' => 'alt_email'])">
                    <label class="col-lg-3 control-label" for="content" id="label">{{trans('Correo alternativo')}}</label>
                    <div class="col-lg-9">
                      <input class="form-control" placeholder="{{trans('Correo alternativo')}}" name="alt_email" value="{{$user->alt_email}}" type="email" >
              ...
              <div class="panel-body" style="margin-bottom: 24px">
                <fieldset>
                  ...
                  <div class="form-group @include('errors.field-class', ['field' => 'local_phone'])">
                    ...
                    <div class="col-lg-9">
                      <input class="form-control" placeholder="{{trans('messages.local_phone')}}" name="local_phone" type="text" autofocus value="{{$user->local_phone}}">
        ...
        <div class="pull-right" style="padding-right: 2%">
            <span class="text-muted"><input type="checkbox" id="check" value="1" onclick="disableElement()" /> {{trans('messages.confirmchange')}}</span>
