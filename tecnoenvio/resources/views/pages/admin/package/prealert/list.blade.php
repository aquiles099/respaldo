...
@section('body')
  ...
  <div class="panel panel-default" id="pnlin">
    <div class="panel-body">
      <table class="table table-striped table-border table-hover" id="dtble_prealert" >
        <thead>
          <tr>
            ...
            <tr item="{{$prealert->toInnerJson()}}">
              ...
              <td>
                <ul class="table-actions">
                  ...
                  <li><a href="{{asset("admin/package/prealert/{$prealert->id}")}}"><i class="fa fa-pencil" title="{{trans('messages.edit')}}"></i></a></li>
                </ul>
              </td>
            </tr>
          @endforeach
