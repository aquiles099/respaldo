      ...
      <div class="col-lg-12" style="padding-left:0px;padding-right:0px;">
        <div class="input-group">
          ...
          <span class="input-group-btn">
            ...
            <a href="{{asset('admin/package/new')}}" onclick="javascript:loadButton(this)" class="btn btn-default" title="{{trans('package.create')}}">
        ...
        <tbody>
          @foreach ($rows[0] as $row)
            <tr item="{{$row->toInnerJson()}}">
              ...
              <td>@if($row->invoice == 0)
                <a href="#" onclick="console.log('aqui')">
              ...
              <td>
                <ul class="table-actions">
                  <li><a onclick="packageDelete($(this))" ><i class="fa fa-times"  title="{{trans('messages.delete')}}"></i></a></li>
