...
class AccountController extends Controller {
  ...
  */
  ...
  public function account(Request $request) {
    ...
    */
    ...
    $packages = Package::byLastEventAndUser($user->id)->get();
  ...
  */
  public function upload(Request $request, $id) {
    ...
    *
    */
    if (is_null($package) || ($package->to_user != $session['data']->id) || ($package->last_event == HConstants::EVENT_DELIVERED)) {
      return $this->doRedirect($request, "/account")
  ...
  */
   ...
   */
    ...
    */
    if($this->isGET($request)) {
      return view('pages.user.address', $vars);
    }
     ...
     */
      ...
      */
      $data = [
        ...
        'file'          => !is_null(Input::file('file')) ? $file->id : null,
        'consolide'     => $request->all()['consolidated']
      ];
      /**
      *
      */
      $prealert = Prealert::create($data);
      $prealert->consolide = $request->all()['consolidated'];
      if (Input::file('file') != null) {
  ...
  */
  public function prealertDetails(Request $request, $id) {
     ...
     */
      ...
      *
      */
      return redirect( $session['type'] == HUserType::OPERATOR ? "admin/package/prealert" : "/account/prealert")->with('successMessage', trans('prealert.updated', [
        'order_service' => $prealert->order_service,
        'code'          => $prealert->code
      ]));
  }
  ...
  */
  private function validateDataPrealert(Request $request, $update = false) {
   return Validator::make($this->clear($request->all()), [
     'order_service' => 'required|string|min:1|max:100|'.($update ? '' : 'unique:prealert,order_service'),
