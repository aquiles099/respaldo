...
var changestatuspackage = function (id) {
  ...
  $.ajax({
    ...
    data: dataString,
    beforeSend: function () {
      $('#cl').html('<p><i class="fa fa-spin fa-spinner"></i> '+translate().loading+'</p>');
    },
...
var detailsreceipt = function (id) {
  ...
  $('#load').html('<p><i class="fa fa-spin fa-spinner"></i> '+translate().loading+'</p>');
  bootbox.dialog({
    title: "<a href='' id='bckic' title='atrás' name =''><span class= 'pull-left glyphicon glyphicon-menu-left'></span></a><span id='tltgnif'>"+translate().receipt+"</span>",
