...
$(document).ready( function() {
  $('#customer').css('width','100% !important');
});
...
function selectUndInt (){
  ...
  pesovol();
  $('#weight').val(($('#weight').val() / 0.39370).toFixed(2));
}
...
<form role="form" action="{{asset($path)}}" onsubmit="createLoad(this)" method="post">
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="form-group row @include('errors.field-class', ['field' => 'customer'])">
          <label class="col-lg-3 control-label">{{trans('numberparts.customer')}}</label>
          <div class="col-lg-9">
            <select style="width:100%" class="form-control" id="customer" name="customer">
        ...
        <div class="form-group row @include('errors.field-class', ['field' => 'pieces'])">
          ...
          <div class="col-lg-9">
            <input class="form-control" placeholder="{{trans('numberparts.pieces')}}" name="pieces" type="number" autofocus maxlength="100" min="0"  value="{{isset($numberparts) ? $numberparts->pieces : clear(Input::get('pieces'))}}" @include('form.readonly')>
        ...
        <div class="form-group row @include('errors.field-class', ['field' => 'note'])">
          ...
          <div class="col-lg-9">
            <input class="form-control" placeholder="{{trans('numberparts.note')}}" name="note" type="text" autofocus maxlength="100" min="0" value="{{isset($numberparts) ? $numberparts->note : clear(Input::get('note'))}}" @include('form.readonly')>
        ...
        <div class=" dimensmedidas  @include('errors.field-class', ['field' => 'large'])"  id="divlarge" >
              ...
              <div class=" dimensmedidas  @include('errors.field-class', ['field' => 'height'])" id="divheight">
                ...
                <div class="col-lg-9">
                  ...
                  <span id="volumea">{{(isset($numberparts) && $numberparts->unidad == 1) ? 'Vkg' : 'Vlb'}}</span>
                  @include('errors.field', ['field' => 'volumetricweight'])
                </div>
              </div>
    ...
    @if(!isset($readonly) || !$readonly)
      <div class="col-lg-12 buttons" id="divButton">
        <button type="submit" class="btn btn-primary pull-right">
          ...
          {{trans(isset($numberparts)?'messages.update' : 'messages.save')}}
        </button>
      </div>
    @endif
  </fieldset>
