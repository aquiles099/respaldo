            ...
            <span class="pull-right">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group row @include('errors.field-class', ['field' => 'consigner'])" id="destination" style="display:block;"}}>
                  ...
                  <div class="col-lg-9">
                  <select style="width:100%;" class="form-control" id="consigner" name="consigner"  @include('form.readonly') >
                ...
                <div class="row" style="margin-right: 0px;margin-left: 0px;">
                  ...
                  <div class="col-md-10">
                     ...
                     @foreach ($typepickup as $transport)
                       <option {{(isset($pickup->type) ? $pickup->type : Input::get('type')) ==$transport->id ? 'selected' : ''}} item="{{$transport }}" value="{{$transport->id}}"> {{$transport->name}}</option>
                     @endforeach
                     </select>
