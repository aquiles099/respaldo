...
<a href="{{asset('admin/security/role/new')}}" onclick="javascript:loadButton(this)" class="btn btn-primary" title="{{trans('role.create')}}">
...
@section('body')
  ...
  <div class="panel panel-default" id="pnlin">
    <div class="panel-body">
      <table class="table table-striped table-hover text-center" id="dtble_role">
        <thead>
          <tr>
