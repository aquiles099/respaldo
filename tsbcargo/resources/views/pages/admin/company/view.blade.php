    ...
    <form role="form" action="" method="" id="formSerial">
      <fieldset class="form">
        ...
        <div class="form-group row @include('errors.field-class', ['field' => 'direction'])">
          ...
          <div class="col-lg-9">
            <textarea class="form-control" style="height:50px;" placeholder="{{trans('company.direction')}}" name="direction" maxlength="255" min="5" required="true" rows="4" @include('form.readonly')>{{isset($company) ? $company->direction : Input::get('direction')}}</textarea>
