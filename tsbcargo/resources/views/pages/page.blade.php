    ...
    <span class="pull-right">
      <div class="dropdown">
        ...
        <ul class="dropdown-menu" id="">
          ...
          <li class="divider"></li>
          <li><a href="javascript:showDateDashboard(1)">{{ucwords(trans('messages.today'))}} <span class="pull-right"><i class="fa fa-clock-o" aria-hidden="true"></i></span></a></li>
          <li><a href="javascript:showDateDashboard(2)">{{ucwords(trans('messages.yesterday'))}} <span class="pull-right"><i class="fa fa-undo" aria-hidden="true"></i></span></a></li>
          <li><a href="javascript:showDateDashboard(3)">{{ucwords(trans('messages.month'))}} <span class="pull-right"><i class="fa fa-calendar-o" aria-hidden="true"></i></span></a></li>
          <li><a href="javascript:showDateDashboard(4)">{{ucwords(trans('messages.day'))}}   <span class="pull-right"><i class="fa fa-calendar" aria-hidden="true"></i></span></a></li>
...
<!--{{asset('admin/cargoRelease')}}-->
  <div class="col-md-2">
    <div class="panel panel-primary">
      <a href="{{asset('admin/transport')}}" class="infoRd">
        <div class="panel-body" id="ics-panel-body">
          <h1 class="text-center"><i class="fa fa-bus" aria-hidden="true"></i></h1>
        </div>
      </a>
      <div class="panel-heading"><h4 class=""><span class="text-center">{{trans('menu.transport')}}</span></h4></div>
    </div>
  </div>
<!---->
  <div class="col-md-2">
    <div class="panel panel-primary">
      <a href="{{asset('admin/l/shipments')}}"class="infoRd">
        <div class="panel-body" id="ics-panel-body">
    ...
    <div id="collapse2" class = "panel-collapse collapse ">
      <div class="panel-body">
        @if(isset($receivedBookings) && isset($sendBookings) && isset($transitBookings) && isset($arribedBooking) && isset($deliveredBookings))
          ...
          <!--Recibidos en oficina-->
          <?php $i =1; ?>
          @if ($bookingStatus_number == 1)
            <div class="col-md-5">
            </div>
          @endif
          @if ($bookingStatus_number == 2)
            <div class="col-md-4">
            </div>
          @endif
          @if ($bookingStatus_number == 3)
            <div class="col-md-3">
            </div>
          @endif
          @if ($bookingStatus_number == 4)
            <div class="col-md-2">
            </div>
          @endif
          @if ($bookingStatus_number == 5)
            <div class="col-md-1">
            </div>
          @endif
          @foreach ($bookingStatus as $key => $events)
              <div class="col-md-2">
    ...
    <div id="collapse4" class = "panel-collapse collapse ">
      <div class="panel-body">
          @if(isset($receivedShipments) && isset($sendShipments) && isset($transitShipments) && isset($arribedShipments)  && isset($deliveredShipments))
            ...
            <!--Recibidos en oficina-->
            <?php $i =1; ?>
            @if ($shipmentStatus_number == 1)
              <div class="col-md-5">
              </div>
            @endif
            @if ($shipmentStatus_number == 2)
              <div class="col-md-4">
              </div>
            @endif
            @if ($shipmentStatus_number == 3)
              <div class="col-md-3">
              </div>
            @endif
            @if ($shipmentStatus_number == 4)
              <div class="col-md-2">
              </div>
            @endif
            @if ($shipmentStatus_number == 5)
              <div class="col-md-1">
              </div>
            @endif
            @foreach ($shipmentStatus as $key => $events)
                <div class="col-md-2">
    ...
    <div id="collapse5" class = "panel-collapse collapse ">
      <div class="panel-body">
          @if(isset($receivedReleases) && isset($sendReleases) && isset($transitReleases) && isset($arribedReleases)  && isset($deliveredReleases))
            ...
            <!--Recibidos en oficina-->
            <?php $i =1; ?>
            @if ($releaseStatus_number == 1)
              <div class="col-md-5">
              </div>
            @endif
            @if ($releaseStatus_number == 2)
              <div class="col-md-4">
              </div>
            @endif
            @if ($releaseStatus_number == 3)
              <div class="col-md-3">
              </div>
            @endif
            @if ($releaseStatus_number == 4)
              <div class="col-md-2">
              </div>
            @endif
            @if ($releaseStatus_number == 5)
              <div class="col-md-1">
              </div>
            @endif
            @foreach ($releaseStatus as $key => $events)
                <div class="col-md-2">
