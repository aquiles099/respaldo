...
<a @if(isset($removable) && $removable == false) href="{{asset('account/prealert')}}" @else href="{{asset('admin/prealert')}}" @endif class="btn btn-primary" data-toggle="tooltip" title="{{trans('messages.listprealert')}}">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      @include('pages.user.prealert.form',[
        'path' => isset($removable) && $removable == false ? "/account/prealert/{$prealert->id}" : "/admin/prealert/{$prealert->id}"
      ])
    </div>
  </div>
@stop
