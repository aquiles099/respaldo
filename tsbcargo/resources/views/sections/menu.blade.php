  ...
  else if(Session::get('key-sesion')['type'] == HUserType::OPERATOR)
  {
    ...
    */
    ...
    [
      ...
      * Almacen
      */
      ['id' => '002', 'parent' => '000', 'text' => trans('menu.newwrh')          , 'icon' => 'fa-plus-square'   , 'url' => asset('admin/pckagecurriers/new')                     , 'accesss' => ''],
      ...
      ['id' => '128', 'parent' => '000', 'text' => trans('menu.numberpart')      , 'icon' => 'fa-barcode'       , 'url' => asset('admin/numberparts')                             , 'accesss' => ''],
      ...
      */
      ...
      ['id' => '022', 'parent' => '008', 'text' => trans('menu.services')        , 'icon' => 'fa-random'        , 'url' => asset('admin/service')                                 , 'accesss' => ''],
      ...
      */
      ...
      ['id' => '215', 'parent' => '212', 'text' => trans('menu.list')            , 'icon' => 'fa-list'          , 'url' => asset('admin/l/shipments')                                , 'accesss' => ''],
      /**
      * Proveedores
      */
      ...
      */
      ...
      ['id' => '039', 'parent' => '038', 'text' => trans('menu.new')          , 'icon' => 'fa-plus'   , 'url' => asset('admin/transport/new')                     , 'accesss' => ''],
      ...
      */
      ...
      //['id' => '203', 'parent' => '200', 'text' => trans('Importar XLS')         , 'icon' => 'fa-newspaper-o'         , 'url' => asset('admin/user/xls')                            , 'accesss' => ''],
