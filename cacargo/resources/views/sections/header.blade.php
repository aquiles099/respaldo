...
<head>
    ...
    <title>@yield('pageTitle', trans('Murano'))</title>

    <!-- Customize favicon-->
    <link rel="shortcut icon" type="image/png" href="{{isset($configuration_header) ? ($configuration_header->logo_ics == '') ? asset('/uploads/logo/005.png') : asset('/uploads/logo/005.png') : asset('/uploads/logo/005.png')}}"/>
   ...
   <!-- <link href="https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i" rel="stylesheet">-->
    ...
    <!-- Custom Datepicker  -->
    <link href="{{asset('libs/bootstrap-datepicker3.css')}}" rel="stylesheet" type="text/css"/>

    <link href="{{asset('libs/jquery-ui.css')}}" rel="stylesheet" type="text/css">
