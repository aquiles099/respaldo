      ...
      <div class="panel-body">
        <form id="formulario"role="form" action="{{asset('/login')}}" method="post">
          <fieldset>
            ...
            <a href="{{asset('/recover-password')}}" style="font-size:14px;"class="btn text-red">{{trans('Olvidé mi contraseña')}}</a><br>
            ...
            <div style="padding-left:74px;font-size:14px;">
              ...
              <a class="btn" style="color:#23527c;" href="{{asset('/register')}}" id ="drdusr"> {{trans('Regístrate')}}</a>
            </div>
            <div class="col-md-3">
