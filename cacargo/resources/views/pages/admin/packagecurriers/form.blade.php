      ...
      <div class="col-md-12">
        <select class="form-control" id="courierSelect" name="courierSelect" @include('form.readonly')>
          @foreach ($couriers as $courier)
            <option {{(isset($package->from_courier) ? $package->from_courier : Input::get('from_courier')) == $courier->id ? 'selected' : ''}} value="{{$courier->id}}">{{strtoupper($courier->name)}}</option>
          @endforeach
        </select>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="form-group row @include('errors.field-class', ['field' => 'service_order'])" id=""  >
              <div class="col-lg-3">
                <label for="service_order">{{trans('package.tracking')}}</label>
                <span id="ics_service_order" class="pull-right"></span>
              </div>
              <div class="col-lg-9">
                <div class="input-group" style="width:94%!important" >
                  <input class="form-control form_dimension" placeholder="{{trans('package.tracking')}}" id="service_order" name="service_order" type="text" maxlength="25" min="10" required="true" value="{{isset($package) ? $package->order_service : clear(Input::get('service_order'))}}">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="row">
                  ...
                  <div class="col-lg-9">
                    ...
                    <option value="" cost="0">{{trans('package.nottype')}}</option>
                        @foreach ($transports as $transport)
                          ...
                          <option {{(isset($package) ? $package->type : Input::get('type')) == $option['id'] ? 'selected' : ''}} item="{{$transport->toInnerJson()}}" value="{{$option['id']}}" cost="{{$option['price']}}">{{ucwords($option['text'])}} </option>
                        @endforeach
                    </select>
              ...
              <div class="hidden form-group row @include('errors.field-class', ['field' => 'addcharge'])" >
              ...
              <div class="hidden form-group row @include('errors.field-class', ['field' => 'office'])" id="officeDiv" >
                ...
                <!-- -->
                <div class="hidden form-group row @include('errors.field-class', ['field' => 'category'])" id="categoryDiv" >
                ...
                <!-- -->
                <div class="hidden form-group row @include('errors.field-class', ['field' => 'consolidate'])" id="consolidate" style="display:block;">
              ...
              <div class="col-md-6">
                ...
                <div class="hidden form-group row @include('errors.field-class', ['field' => 'costadd'])" id="divsubtotal" >
                ...
                <!--promotion-->
                <div class="hidden form-group row @include('errors.field-class', ['field' => 'promotionval'])" id="divalpromotion"  >
