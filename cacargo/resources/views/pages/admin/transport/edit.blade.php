...
@section('title-actions')
  <div class="btn-group" role="group" item="{{$transport->toInnerJson()}}">
    <a href="{{asset('admin/service')}}" onclick="loadButton(this)" class="btn btn-default" title="{{trans('transport.list')}}">
...
<div class="panel panel-default">
  ...
  @include('pages.admin.transport.form', [
    'path' => "/admin/service/{$transport->id}"
  ])
  </div>
</div>
@stop
