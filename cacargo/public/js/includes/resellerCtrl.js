...
$(document).ready(function() {
  ...
  if ($('#type_packages').val() == '0') {
    $('#specific_packages').css('display','none');
    $('#label_specific').css('display','none');
  }
  /**
  *
  */
  ...
  */
   ...
   *
   */
   $('#type_packages').select2({
     width: '100%'
   });
   $('#type_packages').change(() => {
     console.log($('#type_packages').val());
     $('#specific_packages').css('display','block');
     $('#label_specific').css('display','block');
   });
  /**
  *
  */
