...
class PackageController extends Controller {
  ...
  public function createcurriers(Request $request) {
    ...
    */
    ...
    $packageData = [
        ...
        'to_user'           => $userdestino,
        //'tracking'          => (!isset($request->all()['tracking']))&&($request->all()['tracking']== "") ? null :$request->all()['tracking'],
    ...
    */
     ...
     *
     */
    return redirect("/admin/packagelist")->with('successMessage', trans('package.created', [
      'tracking' => $package->tracking,
      'id' => $package->id
    ]));
  }
  ...
  */
  public function detailscurriers(Request $request, $id, $readonly = false) {
    ...
    */
    ...
    if($idaddcharge != "") {
      ...
      return redirect("/admin/packagelist")->with('successMessage', trans('package.editp',
      [
      'tracking' => $package->tracking,
      'id'       => $package->id
    ]));
  ...
  public function delete(Request $request, $id) {
    $redirect = redirect("/admin/packagelist");
    $package = Package::find($id);
    if(is_null($package)) {
