...
<?php $__env->startSection('pageTitle', trans('messages.logIn')); ?>
      ...
      <div class="panel-heading">
        <div class="text-center text-muted">
          <i aria-hidden="true" class="fa fa-sign-in"></i>
            <?php echo e(trans('messages.logIn')); ?>

        </div>
      </div>
      <div class="panel-body">
        <form id="formulario"role="form" action="<?php echo e(asset('/login')); ?>" method="post">
          <fieldset>
            <div class="form-group <?php echo $__env->make('errors.field-class', ['field' => 'username'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>">
              <input id="username" class="form-control" placeholder="<?php echo e(trans('messages.email')); ?>" name="username" type="text" autofocus maxlength="40" min="5" required="true" value="" value="<?php echo e(Input::get('username')); ?>">
              <?php echo $__env->make('errors.field', ['field' => 'username'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
            <div class="form-group <?php echo $__env->make('errors.field-class', ['field' => 'password'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>">
              <input id="password" class="form-control" placeholder="<?php echo e(trans('messages.password')); ?>" name="password" type="password" value="" maxlength="20" min="5" required="true">
              <?php echo $__env->make('errors.field', ['field' => 'password'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
            <!-- Change this to a button or input when using this as a form -->
            <a href="<?php echo e(asset('/recover-password')); ?>" style="font-size:14px;"class="btn text-red"><?php echo e(trans('Olvidé mi contraseña')); ?></a><br>

            <div class="col-md-2"></div>
            <button style="padding-left: 60px;padding-right: 60px;"onclick="verifyTerms()" id="loginButton" type="submit" class="btn btn-primary col-md-8"><?php echo e(trans('messages.doLogIn')); ?></button>
            <div class="col-md-2"> </div>
            ...
            <div style="padding-left:74px;font-size:14px;">
              ...
              <a class="btn" style="color:#23527c;" href="<?php echo e(asset('/register')); ?>" id ="drdusr"> <?php echo e(trans('Regístrate')); ?></a>
            </div>
            <div class="col-md-3">
